...
using ShoppingCart.Service.OrdersApi.Extentions;
using ShoppingCart.Service.OrdersApi.Service;
...
namespace ShoppingCart.Service.OrdersApi
{
                ...
                option.AddSecurityRequirement(new OpenApiSecurityRequirement
    {
        { new OpenApiSecurityScheme
        {
            ...
            Services.AddHttpClient("Cart", u => u.BaseAddress =
            new Uri(Configuration["ServiceUrls:CartApi"])).AddHttpMessageHandler<BackendApiAuthenticationHttpClientHandler>();
